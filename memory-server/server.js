...
- 如果是未来安排、承诺、约定、计划，只有在它尚未完成、需要后续兑现、会持续影响后续互动，或用户以后很可能单独追问时，才归为 P，并保留具体日期和行动。
- 当天内已经发生、正在执行或只是推动场景流转的普通安排、照顾、采购、陪伴、会议、修改文件、回家、吃饭、休息等，不要单独归为 P，通常归为 E，并合并进所在事件。
