...
- 如果同一事实、同一设定、同一地点或同一事件已经存在于长期记忆中，应优先合并，而不是生成新的重复记忆。
...
# 10大精细分类说明：
分类只能从以下十类中选择。请判断这条记忆的核心是什么：
如果核心是一次具体共同经历、场景节点或有回忆价值的互动，通常归为 E；
只有当核心明显属于稳定设定、关系变化、重要物品、地点本身、承诺计划、规则边界、深层心理或核心设定时，才归入其他分类。
